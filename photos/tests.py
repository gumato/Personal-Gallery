...
class ImageTestClass(TestCase):
    ...
    def setUp(self):
        ...
        pricilla.save()
        self.image= Image(image = 'pricilla', image_name = 'image name', description = 'description', location = 'America')
        
        # Creating a new tag and saving it image
        self.new_category = Category(name = 'testing')
        self.new_category.save()

        self.new_image= Image(image = 'Test Image',image_name = 'This is a random test Post', description = 'description',location = 'America')
        self.new_image.save()
